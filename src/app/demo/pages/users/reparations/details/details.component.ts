...
export class DetailsComponent implements OnInit {
  ...
  constructor(private activatedRoute: ActivatedRoute, private reparationService: ReparationService) { }

  ngOnInit(): void {
    this.loading = true;
    this.activatedRoute.params.subscribe(params => {
      this.id = params['id'];
      this.reparationService.detailReparation(this.id).subscribe((reparation: IResponse) => {
